...
const mobileSocialLinks = [
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/selfd_rivecarrohtak",
    icon: (
          ...
          <div className="flex items-center justify-between h-[44px]">
            <div className="flex items-center gap-6 text-xs">
              ...
              <a href="tel:+918708765123" className="flex items-center gap-2 text-body hover:text-primary transition-colors duration-200">
                ...
                <span className="font-semibold tracking-wide">+91 870 876 5123</span>
              </a>
      ...
      >
        ...
        <div className="px-6 py-5 border-t border-white/10 space-y-3.5">
          ...
          <div className="flex items-center gap-3 text-sm text-body">
            ...
            <a href="tel:+918708765123" className="hover:text-primary transition-colors">+91 870 876 5123</a>
          </div>
          <div className="flex items-center gap-3 text-sm text-body">
            <svg className="w-4 h-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
