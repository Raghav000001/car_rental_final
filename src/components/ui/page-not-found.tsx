    ...
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        ...
        <div className="flex gap-6 mt-8">
          ...
          <button
            onClick={() => router.push("/")}
            className="group bg-black text-white hover:bg-gray-900 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 cursor-pointer"
          >
            <Home
              size={20}
